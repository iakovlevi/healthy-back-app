...
- [ ] Подтвердить корневую причину (ключ пользователя / окружение).
- [ ] Реализовать fallback + миграцию legacy-данных.
- [ ] Добавить meta и подробные логи синхронизации.
- [~] Добавить клиентский recovery banner.
- [~] Добавить тесты (backend + frontend).
- [~] Добавить аналитическое событие `sync_empty_after_write`.
