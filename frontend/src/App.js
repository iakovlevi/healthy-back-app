...
const EXERCISES = {
    ...
    piriformis_stretch: { id: 'piriformis_stretch', title: 'Растяжка грушевидной', equipment: 'Коврик', description: 'Лежа в позиции "цифра 4", мягко тяните бедро к себе.', duration: 60, type: 'relax', zones: ['Ягодицы'], pressureImpact: false, position: 'lying' },
    neck_lateral: { id: 'neck_lateral', title: 'Наклоны шеи', equipment: 'Стул', description: 'Мягко наклоняйте голову к плечу, удерживая плечи опущенными.', duration: 30, type: 'relax', zones: ['Шея'], pressureImpact: false, position: 'sitting' },

    // Strength: Core Stability
    bird_dog: { id: 'bird_dog', title: 'Птица-Собака', equipment: 'Коврик', description: 'Поочередно вытягивайте разноименную руку и ногу, удерживая поясницу стабильной.', duration: 45, type: 'strength', zones: ['Спина', 'Кор', 'Ягодицы'], pressureImpact: false, position: 'combined' },
    dead_bug: { id: 'dead_bug', title: 'Мертвый жук', equipment: 'Коврик', description: 'Сохраняйте поясницу прижатой, двигая противоположные руку и ногу.', duration: 45, type: 'strength', zones: ['Кор'], pressureImpact: false, position: 'lying' },
    side_plank: { id: 'side_plank', title: 'Боковая планка', equipment: 'Коврик', description: 'Упор на локте, таз поднят. При дискомфорте замените на Dead Bug.', duration: 30, type: 'strength', zones: ['Кор', 'Спина'], pressureImpact: true, position: 'lying' },

    // Strength: Low Pressure Dumbbell
    tricep_ext_lying: { id: 'tricep_ext_lying', title: 'Французский жим лежа', equipment: '2 Гантели', description: 'Разгибайте руки с гантелями лежа, локти стабильны. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Трицепс'], pressureImpact: false, position: 'lying' },
    bicep_curl_sitting: { id: 'bicep_curl_sitting', title: 'Сгибание на бицепс сидя', equipment: '2 Гантели', description: 'Сидя с опорой спины, сгибайте руки к плечам. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Бицепс'], pressureImpact: false, position: 'sitting' },
    concentration_curl: { id: 'concentration_curl', title: 'Концентрированный подъем', equipment: '1 Гантель', description: 'Локоть упирается в бедро, поднимайте гантель по дуге. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Бицепс'], pressureImpact: false, position: 'sitting' },
    lateral_raise_sitting: { id: 'lateral_raise_sitting', title: 'Разводка гантелей сидя', equipment: '2 Гантели', description: 'Поднимайте руки в стороны до уровня плеч, спина прижата. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Плечи'], pressureImpact: false, position: 'sitting' },
    front_raise_sitting: { id: 'front_raise_sitting', title: 'Подъем перед собой сидя', equipment: '2 Гантели', description: 'Поднимайте гантели вперед до уровня плеч, корпус стабилен. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Плечи'], pressureImpact: false, position: 'sitting' },
    rear_delt_lying: { id: 'rear_delt_lying', title: 'Разводка на заднюю дельту', equipment: '1 Гантель', description: 'Лежа на боку, поднимайте гантель вверх, как "открытие двери". Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Плечи', 'Спина'], pressureImpact: false, position: 'lying' },
    floor_fly: { id: 'floor_fly', title: 'Разводка лежа на полу', equipment: '2 Гантели', description: 'Разводите руки в стороны с легким весом, не прогибаясь в пояснице. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Грудь'], pressureImpact: false, position: 'lying' },
    dumbbell_pullover: { id: 'dumbbell_pullover', title: 'Пуловер с гантелью', equipment: '1 Гантель', description: 'Опускайте гантель за голову с нейтральной поясницей. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Спина', 'Грудь'], pressureImpact: false, position: 'lying' },
    supported_row: { id: 'supported_row', title: 'Тяга с опорой рукой', equipment: '1 Гантель', description: 'Опирайтесь рукой о стул или стол, тяните гантель к поясу. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Спина'], pressureImpact: false, position: 'standing' },
    calf_raise_sitting: { id: 'calf_raise_sitting', title: 'Подъем на носки сидя', equipment: '2 Гантели', description: 'Гантели на коленях, поднимайте пятки вверх. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Ноги'], pressureImpact: false, position: 'sitting' },
    side_leg_lift: { id: 'side_leg_lift', title: 'Подъем ноги лежа', equipment: 'Коврик', description: 'Лежа на боку, поднимайте ногу вверх, удерживая корпус. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Ягодицы', 'Ноги'], pressureImpact: false, position: 'lying' },
    glute_bridge_weighted: { id: 'glute_bridge_weighted', title: 'Ягодичный мост', equipment: '1 Гантель', description: 'Гантель на тазу, поднимайте его вверх до прямой линии. Выдох на усилии, без задержки дыхания.', duration: 45, isStrength: true, type: 'strength', zones: ['Ягодицы'], pressureImpact: false, position: 'lying' },
    ...
    hip_flexor_stretch: { id: 'hip_flexor_stretch', title: 'Растяжка сгибателей', equipment: 'Коврик', description: 'Выпад с мягким наклоном таза вперед, без прогиба в пояснице.', duration: 45, type: 'mobility', zones: ['Ноги'], pressureImpact: false, position: 'combined' },
    doorway_stretch: { id: 'doorway_stretch', title: 'Растяжка в проеме', equipment: 'Дверной проем', description: 'Опирайтесь предплечьями о косяк и мягко подайтесь вперед.', duration: 45, type: 'mobility', zones: ['Грудь', 'Плечи'], pressureImpact: false, position: 'standing' },
    seated_twist: { id: 'seated_twist', title: 'Скручивания сидя', equipment: 'Стул', description: 'Сидя на стуле, мягко вращайте грудной отдел в стороны.', duration: 40, type: 'mobility', zones: ['Спина'], pressureImpact: false, position: 'sitting' },
    chin_tucks: { id: 'chin_tucks', title: 'Задвигание подбородка', equipment: 'Стул', description: 'Уводите подбородок назад, удлиняя шею, без запрокидывания.', duration: 40, type: 'mobility', zones: ['Шея'], pressureImpact: false, position: 'sitting' }
};
...
const WORKOUTS = [
    ...
    { id: 'mcgill_big_three', title: 'Большая тройка', subtitle: 'Стабилизация позвоночника по МакГиллу', duration: '10 мин', intensity: 'Средняя', type: 'strength', targets: ['Кор', 'Спина'], color: 'bg-emerald-100 text-emerald-800', exercises: ['bird_dog', 'dead_bug', 'side_plank'] },
    { id: 'office_five', title: 'Офисная пятиминутка', subtitle: 'Разминка без коврика и переодевания', duration: '5 мин', intensity: 'Лёгкая', type: 'mobility', targets: ['Шея', 'Спина', 'Грудь'], color: 'bg-sky-100 text-sky-800', exercises: ['seated_twist', 'chin_tucks', 'neck_lateral', 'doorway_stretch'] },
    { id: 'hip_flow', title: 'Анти-Сидение', subtitle: 'Раскрыть таз после долгого дня', duration: '12 мин', intensity: 'Средняя', type: 'mobility', targets: ['Ноги', 'Ягодицы'], color: 'bg-lime-100 text-lime-800', exercises: ['hip_flexor_stretch', 'glute_roll', 'piriformis_stretch', 'glute_bridge_weighted'] },
    { id: 'healthy_sleep', title: 'Здоровый сон', subtitle: 'Расслабление перед сном', duration: '8 мин', intensity: 'Очень лёгкая', type: 'relax', targets: ['Шея', 'Спина', 'Ягодицы'], color: 'bg-cyan-100 text-cyan-800', exercises: ['child_pose', 'thoracic_roll', 'sacrum_release', 'neck_lateral'] },
    { id: 'arms_shoulders_lp', title: 'Руки и Плечи без ВБД', subtitle: 'Тонус верха тела с гантелями', duration: '12 мин', intensity: 'Средняя', type: 'strength', targets: ['Бицепс', 'Трицепс', 'Плечи'], color: 'bg-rose-100 text-rose-800', exercises: ['bicep_curl_sitting', 'tricep_ext_lying', 'lateral_raise_sitting', 'front_raise_sitting'] },
    { id: 'torso_lp', title: 'Торс без ВБД', subtitle: 'Грудь и спина с опорой', duration: '15 мин', intensity: 'Средняя', type: 'strength', targets: ['Грудь', 'Спина'], color: 'bg-indigo-100 text-indigo-800', exercises: ['floor_fly', 'supported_row', 'rear_delt_lying', 'glute_bridge_weighted'] },
    { id: 'legs_lp', title: 'Ноги без приседаний', subtitle: 'Низ тела без осевой нагрузки', duration: '15 мин', intensity: 'Средняя', type: 'strength', targets: ['Ноги', 'Ягодицы'], color: 'bg-amber-100 text-amber-800', exercises: ['side_leg_lift', 'side_leg_lift', 'calf_raise_sitting', 'glute_bridge_weighted', 'hip_flexor_stretch'] }
];
...
const HomeView = ({ startWorkout, history, painLogs, readinessLogs, onLogReadiness, achievements }) => {
    ...
    const recommendation = useMemo(() => {
        ...
        if (typeof readinessValue === 'number') {
            if (readinessValue <= 3) {
                return { title: 'Низкая готовность', reason: `Показатели слишком низкие (${readinessValue}).`, workouts: WORKOUTS.filter(w => w.type === 'relax') };
            }
            if (readinessValue >= 7) {
                return { title: 'Пик готовности', reason: `Показатели высокие (${readinessValue}).`, workouts: WORKOUTS.filter(w => w.type === 'strength') };
            }
        }
        ...
        if (!lastReadiness && !lastLegacyLog) {
            return { title: 'А пока зарядка', reason: 'Завершите её сегодня утром, чтобы чувствовать результат.', workouts: [WORKOUTS.find(w => w.id === 'morning_mobility')] };
        }

        if (isLateEvening) return { title: 'Крепкий сон и релакс', reason: 'Спокойная разминка поможет расслабиться.', workouts: WORKOUTS.filter(w => w.type === 'relax') };
        if (isMorning) return { title: 'Доброе утро', reason: 'Утренняя разминка подготовит к дню.', workouts: [WORKOUTS.find(w => w.id === 'morning_mobility')] };
        if (lastLegacyLog && lastLegacyLog.energy < 4) return { title: 'Низкая активность', reason: 'Похоже, сегодня было мало движения.', workouts: WORKOUTS.filter(w => w.type === 'mobility') };
        return { title: 'Зарядка и тренировка', reason: 'Время привести тело в тонус.', workouts: WORKOUTS.filter(w => w.type === 'strength') };
...
export { AuthScreen, ReadinessSurveyModal, checkAchievementConditions, apiRequest, mockApi, mergeLegacyData, WorkoutsView, WorkoutPlayer, EXERCISES, WORKOUTS };
